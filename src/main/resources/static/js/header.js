        ...
        .then( data => {  console.log(data);
            ...
            html +=`<li class="nav-item">
                        <a class="nav-link" href="#">
                            <img src="${ data.mimg.includes('kakao') ? data.mimg : '/img/'+data.mimg }" style=" width:60px; height:60px; padding: 1px; object-fit: cover; border-radius: 30px;  border:1px solid #bfbebe;" />
                            ${ data.mid }님
