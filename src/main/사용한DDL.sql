...
insert into point ( pcomment , pcount , mno ) values( "회원가입축하" , 100 , 1  );
insert into point ( pcomment , pcount , mno ) values( "로그인" , 1 , 1  );
insert into point ( pcomment , pcount , mno ) values( "아이템구매" , -50 , 1  );
insert into point ( pcomment , pcount , mno ) values( "포인트구매" , 2000 , 1  );
insert into point ( pcomment , pcount , mno ) values( "아이템구매" , 1000 , 1  );
